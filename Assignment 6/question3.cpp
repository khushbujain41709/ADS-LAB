...
// a = 7 0 9
// b = -1 6 3 5
// after recursion a becomes 0 7 9 and b becomes -1 3 5 6 
// now merging two sorted array
// Time complexity - O(n logn) but number of operations = 2nlogn(base 2) 
// Space complexity - O(n logn) but can be improved and made to O(n)
